...
var service = require('../api_server/fileName_server');
router.post('/api/filePath/fileNameFind', (req, res) => {
  ...
  service.fileNameFind((data) => {
    returnData.data = data.data;
    returnData.count = data.count;
    res.send(returnData)
  }, params)
});
router.post('/api/filePath/fileNameSave', (req, res) => {
  let params = common.setParams(req.body.params);
  let returnData = common.setData();
  service.fileNameSave((data, msg) => {
    if (data == 'E') {
